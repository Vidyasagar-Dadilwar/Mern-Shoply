                        ...
                        <Row style={{flexDirection: "column", gap: "0.55rem"}}>
                            ...
                            <Col style={{display: "flex", gap: "6px"}}>
                                ...
                                <div style={{display: "flex", alignItems: "center"}}>
                                    <button onClick={() => setCount(count > 0 ? count - 1 : 0)} className="btn btn-sm btn-outline-secondary" type="button" style={{borderRightWidth: "0px", borderTopRightRadius: "0px", borderBottomRightRadius: "0px"}}>-</button>
