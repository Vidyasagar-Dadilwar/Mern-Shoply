...
export default function DeleteOrder({ setOnDirty, id }) {
    ...
    return (
        <>
            <button className="btn" type="button" style={{ color: "red", padding: "3px 6px" }} data-bs-toggle="modal" data-bs-target={`#del_${id}`}>
                        ...
                        <div className="modal-body">
                            <form onSubmit={onDeleteOrder} noValidate>
                                <div className="container">
                                    <div className="row justify-content-center">Are you sure you want to delete order?</div>
                                    <div className="row justify-content-center" style={{ marginTop: "0.5em" }}>
                                        <div className="col text-center" style={{ marginTop: "0.5em" }}>
